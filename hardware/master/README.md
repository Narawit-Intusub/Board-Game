...
- **ระนาบทองแดง (Copper Planes & Stacks):**
  - **Top Layer (`F.Cu`):** เทระนาบไฟเลี้ยง **`+5V` Power Plane (VCC Plane)** กระจายกระแสไฟ 5V เต็มพื้นที่ด้านบน ช่วยลดความต้านทานและแรงดันตกเมื่อ LED เปิดสว่างพร้อมกัน
  - **Bottom Layer (`B.Cu`):** เทระนาบกราวด์ **`GND` Plane** เต็มพื้นที่ด้านล่าง เพื่อเป็น Low-Impedance Return Current Path และลดสัญญาณรบกวน EMI ตามมาตรฐาน SOP บอร์ด 2 เลเยอร์
